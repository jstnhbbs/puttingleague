...
// Or use ngrok: 'https://tigers-recognized-ethics-asylum.trycloudflare.com'
export const API_URL = process.env.NEXT_PUBLIC_API_URL || 'https://tigers-recognized-ethics-asylum.trycloudflare.com'
