...
// Or use ngrok: 'https://crop-tubes-fioricet-quantities.trycloudflare.com '
export const API_URL = process.env.NEXT_PUBLIC_API_URL || 'https://crop-tubes-fioricet-quantities.trycloudflare.com '
