...
// Or use ngrok: 'https://scene-tamil-supervision-frost.trycloudflare.com'
export const API_URL = process.env.NEXT_PUBLIC_API_URL || 'https://scene-tamil-supervision-frost.trycloudflare.com'
